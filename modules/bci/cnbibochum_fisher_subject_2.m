...
%% Exporting figure
filename = fullfile(figdir, [subject '_discriminancy_evolution_day.pdf']);
util_disp(['[out] - Exporting discriminancy maps per week to ' filename], 'b');
